  ...
  const onSubmit = async (Formdata: AuthFormInputs) => {
    ...
    toast.loading({
      ...
      options: {
        ...
        onSuccess: () => {
          setTimeout(async () => {
            const updatedSession = await getSession(); // ✅ Now works inside async function
    ...
    <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full p-6 rounded-lg  sm:p-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="w-full">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base"
              />
              <span
          ...
          <button
            type="submit"
            className="w-full bg-green-600 text-white py-2 rounded-md hover:bg-green-700 transition flex items-center justify-center gap-2 text-sm sm:text-base md:text-lg"
          >
        ...
        <p className="text-xs sm:text-sm text-center mt-3 sm:mt-4">
          ...
          <Link href="/api/auth/signup" className="text-blue-500 font-bold">
            Sign Up
          </Link>
        </p>
      </div>
